...
import org.gwtd3.demo.client.conditions.Conditions;
import org.gwtd3.demo.client.conditions.WebElementCondition;
import org.gwtd3.demo.client.test.ui.TestSessionContainer;
import org.gwtd3.demo.client.test.ui.UnitTestWidget;
...
public class TestSuiteScreen extends PageObject {

    public TestSuiteScreen(final WebDriver driver) {
        super(driver);
    }
    ...
    /**
     * Return a condition that check that all unit tests of the suite
     * are successful
     * @return
     */
