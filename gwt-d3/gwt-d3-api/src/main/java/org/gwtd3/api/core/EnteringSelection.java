...
public class EnteringSelection extends JavaScriptObject {
	 ...
	 * operators (with the exception of data) automatically skip null elements,
	 * thereby preserving the index of the existing selection.
	 * <p>
	 ...
	 * element, or null if there is no matching element. In this case, the
	 * specified selector is invoked in the same manner as other operator
