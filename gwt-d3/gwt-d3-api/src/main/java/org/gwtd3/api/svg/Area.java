...
public class Area extends JavaScriptObject implements IsFunction {
    ...
    public final native InterpolationMode interpolate() /*-{
        return @org.gwtd3.api.svg.Area.InterpolationMode::fromValue(Ljava/lang/String;)(this.interpolate());
    }-*/;
    ...
    public final native Area interpolate(final InterpolationMode i) /*-{
		return this.interpolate(i.@org.gwtd3.api.svg.Area.InterpolationMode::getValue()());
    }-*/;
