...
public class D3 extends JavaScriptObject {
     ...
     * elements in the current document match the specified
     * selector, returns the empty selection. If multiple elements match the selector, only the first matching element
    ...
    /**
     * Selects the specified widget. This is useful if you already have a reference to a widget, or a global such as
     * {@link RootPanel#get()}
     * 
     * @param widget
     ...
     * (top-to-bottom). If no elements in the current document
    ...
    /**
     * Selects the specified array of elements. This is useful if you already have a reference to nodes, such as
     * d3.selectAll(this.childNodes) within an event listener, or a global
     * such as document.links. The nodes argument doesn't have to be an array, exactly; any pseudo-array that can be
     * coerced into an array (e.g., a NodeList or arguments) will
     * work.
     * 
     * @param nodes
     * @return
    ...
    /**
     * Constructs a new RGB color with the specified r, g and b channel values. Each channel must be specified as an
     * integer in the range [0,255]. The channels are available as the
    ...
    /**
     * Constructs a new HSL color by parsing the specified color string. The color string may be in a variety of
     * formats:
     * <ul>
    ...
    /**
     * Constructs a new HSL color with the specified hue h, saturation s and lightness l. The hue must be a number in
     * the range [0,360]. The saturation and lightness must be in the
     ...
     * by more specific versions of the
     * 
     * @param a
     * @param b
     * @return
     ...
     * <p>
     * Returns a new format function with the given string specifier. A format function takes a number as the only
     * argument, and returns a string representing the formatted number.
     * 
