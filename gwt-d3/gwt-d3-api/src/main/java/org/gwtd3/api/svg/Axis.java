...
public class Axis extends JavaScriptObject implements IsFunction {
     ...
     * <p>
     * For a vertical axis, specify {@link Orientation#LEFT} or {@link Orientation#RIGHT}; for a horizontal axis,
     * specify {@link Orientation#TOP} or {@link Orientation#BOTTOM}.
     * <p>
    ...
    /**
     * Specify the argument that will be passed to the associated scale {@link Scale#ticks()} method to compute the tick
     * values. This version specify the desired tick count.
     * <p>
     * The count parameter is also passed to the {@link Scale#tickFormat(int, String)} method to generate the default
     * tick format.
     * 
     * 
     * @param count
    ...
    /**
     * Get the arguments that will be passed to the associated scale {@link Scale#ticks()} method to compute the tick
     * values.
     * 
     * @param count
     * @return
     ...
     * <p>
     * Sets the number of uniform subdivision ticks to make between major tick marks. The specified count specifies the
     * number of minor ticks, which is one less than the number of subdivisions.
     * <p>
     * For example, axis.tickSubdivide(1) produces one minor tick per major tick, thus cutting the space between each
     * major tick in two. As another example, decimal subdivision is specified as axis.tickSubdivide(9).
     * 
     * @param count
